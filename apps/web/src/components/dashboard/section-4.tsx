          ...
          <CardContent className="mt-2">
            ...
            <div className="space-y-2 border-b">
              <div className="flex justify-between items-center">
                ...
                <span className="font-medium text-lg text-primary-foreground">88%</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-sm text-muted-foreground">Total de CO₂ emitido</span>
                <span className="font-medium text-lg text-primary-foreground">68.692t</span>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="mt-2 gap-2 flex flex-col">
            ...
            <div className="my-2 gap-1 flex flex-col">
              <div className="flex items-center">
                <p className="text-2xl font-bold text-foreground min-w-36">Óleo Diesel</p>
              ...
              <div className="flex items-center ">
                <div className="text-2xl font-bold text-foreground min-w-36">Eletricidade</div>
