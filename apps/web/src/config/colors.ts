...
// Vintage Vibe Palette
export const vintageVibeColors = [
  "#CCADB8", // Mauve
  "#EAD4AA", // Vintage Beige
  "#A9A587", // Olive Beige
  "#E8E1A0", // Light Gold
  "#A3D2CA", // Soft Teal
  "#D4A59A", // Dusty Rose
  "#B0C4B1", // Pale Sage
  "#ECDCBF", // Antique White
  "#B9A89A", // Taupe
  "#7F9183", // Faded Green
  "#F0E2C4", // Pale Peach
];
